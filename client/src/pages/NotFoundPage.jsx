  ...
  return (
    <div className="shell flex min-h-screen items-center py-12">
      <div className="glass-panel mx-auto w-full max-w-3xl px-6 py-16 text-center sm:px-10">
        ...
        <p className="section-kicker mt-6">navigation lost in sector</p>
        <h1 className="display-title mt-4 text-6xl text-white">Маршрут не найден</h1>
        <p className="mx-auto mt-4 max-w-xl text-base leading-8 text-slate-400">
          Такой страницы в приложении нет. Вернитесь на главную или откройте нужный раздел через станционную навигацию.
        </p>
